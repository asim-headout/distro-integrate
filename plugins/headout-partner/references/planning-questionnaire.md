...
10. **Payment service boundary**
   - Which partner PSP/payment service owns payment authorization, 3DS/redirects, refunds, and saved
     methods?
   - Confirm the handoff point where Headout booking capture should occur after PSP success.
...
12. **Auth and account dependency**
    ...
    - Confirm whether account/profile pages are in scope or should remain partner-owned.
