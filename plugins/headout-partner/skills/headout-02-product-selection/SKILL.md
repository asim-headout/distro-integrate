...
3. Build the frontend to the **page recipes** — `page-tour` (product detail) and `page-select` (date/time/variant). They are the source of truth for section order, derivation, conditional rules, components, and visual language.
...
- **Frontend — look & structure (page recipes):** [../page-tour/SKILL.md](../page-tour/SKILL.md) (product detail), [../page-select/SKILL.md](../page-select/SKILL.md) (date/time/variant)
